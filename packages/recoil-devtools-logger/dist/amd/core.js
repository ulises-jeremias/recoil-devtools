...
define(["require", "exports", "./util/helpers", "./util/diff"], function (require, exports, helpers_1, diff_1) {
    "use strict";
    ...
    var printBuffer = function (buffer, options) {
        ...
        buffer.forEach(function (logEntry, key) {
            ...
            var isCollapsed = typeof collapsed === 'function'
                ...
                : collapsed;
            var formattedTime = helpers_1.formatTime(startedTime);
            ...
            if (diff) {
                diff_1.default(prevState, nextState, logger, isCollapsed);
            }
            try {
                logger.groupEnd();
            }
