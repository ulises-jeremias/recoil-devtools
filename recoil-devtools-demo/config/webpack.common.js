  ...
  module: {
    rules: [
      ...
      // the following 3 rules handle font extraction
      {
        ...
        loader:
          'url-loader?limit=10000&mimetype=application/font-woff&name=static/fonts/[name].[hash].[ext]',
      },
      {
      ...
      },
      {
        test: /\.otf(\?.*)?$/,
        use:
          'file-loader?name=static/fonts/[name].[ext]&mimetype=application/font-otf',
      },
    ],
  },
  resolve: {
